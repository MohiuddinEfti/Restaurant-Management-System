...
namespace Restuarent
{
    public partial class Customer : Form
    {
        ...
        {
            button24.Visible = Paid.Visible = label14.Visible = label15.Visible = label13.Visible = pictureBox2.Visible = true;
            button22.Visible = false;
        ...
        */
        ...
        private void Paid_Click(object sender, EventArgs e)
        {
            ...
            cathcer = String.Empty;
            cathcer = "Bkash";
            label12.Text = "Payment Done By";
            groupBox1.Visible = false;
            if (cathcer == "Bkash")
            {
                button22.Visible = true;
        ...
        private void button22_Click_1(object sender, EventArgs e)
        {
            ...
            if (diary > 0)
            {
                MessageBox.Show("Confirm Payment When Order Is Ready");
                textBox2.Text = String.Empty;
                timer1.Enabled = true;
                label4.Visible = true;
                numberbox.Text = string.Empty;
