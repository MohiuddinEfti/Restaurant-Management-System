        ...
        */
        ...
        private void button22_Click(object sender, EventArgs e)
        {
            ...
            string Today = DateTime.Today.ToString("dddd , MMM dd yyyy");
             ...
             connection.Open();
             string sq1 = "INSERT INTO CustomerOrders(CustomerName,TableNo,TotalOrder,OrderTime,Price,Date,Payment,Reference) VALUES('" + name + "','" + tbno + "','" + data + "','" + ab + "','" + tk + "','" + Today + "','" +bkash+ "','" + textBox1.Text.ToString() + "')";
        ...
        private void button22_Click_1(object sender, EventArgs e)
        {
            ...
            if (diary > 0)
            {
                MessageBox.Show("Order Done");
                timer1.Start();
                textBox2.Text =textBox1.Text = richTextBox1.Text= String.Empty;
                groupBox1.Visible = pictureBox2.Visible = label14.Visible = label15.Visible = label13.Visible = button22.Visible = panel1.Visible = false;
                label4.Visible = flowLayoutPanel1.Visible  = label89.Visible = label91.Visible =label92.Visible = flowLayoutPanel2.Visible = flowLayoutPanel3.Visible = flowLayoutPanel4.Visible = true;
