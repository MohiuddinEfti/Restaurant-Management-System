...
namespace Restuarent
{
    public partial class FoodItem : Form
    {
        ...
        private void FoodItem_Load(object sender, EventArgs e)
        {
            ...
            connection55.Open();
            string sql55 = "SELECT * FROM Food WHERE Added='added'";
            ...
            if (add.Contains("added") == true && slist.Contains(9))
            {
                panel9.Visible = true;
            ...
            if (add.Contains("added") == true && slist.Contains(10))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(11))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(12))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(13))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(14))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(15))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(16))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(17))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(18))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(19))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(20))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(21))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(22))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(23))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(24))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(25))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(26))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(27))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(28))
            {
            ...
            if (add.Contains("added") == true && slist.Contains(29))
            {
        ...
        private void button33_Click(object sender, EventArgs e)
        {
            SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["Food"].ConnectionString);
            connection.Open();
            string sql = "UPDATE Food SET FoodStatus='active' WHERE Id=" + Id;
            SqlCommand command = new SqlCommand(sql, connection);
            int diary = command.ExecuteNonQuery();
        ...
        private void button34_Click(object sender, EventArgs e)
        {
            SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["Food"].ConnectionString);
            connection.Open();
            string sql = "UPDATE Food SET FoodStatus='not' WHERE Id=" + Id;
            SqlCommand command = new SqlCommand(sql, connection);
            int diary = command.ExecuteNonQuery();
